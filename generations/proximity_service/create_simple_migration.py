#!/usr/bin/env python3
"""Generate simplified migration.sql without PostGIS/pgvector dependencies"""

migration_sql = """-- Proximity Service Database Migration
...
print("Location: /Users/maryanahermawan/tdd-agent-harness/generations/proximity_service/data/migration.sql")
