...
This script implements the three-agent pattern (initializer + coding agent) and
incorporates all the strategies from the long-running agents guide.

Example Usage:
    python autonomous_agent_demo.py --project-dir ./claude_clone_demo
    python autonomous_agent_demo.py --project-dir ./claude_clone_demo --max-iterations 3
"""
...
Examples:
  ...
  python autonomous_agent_demo.py --project-dir ./claude_clone --max-iterations 3
